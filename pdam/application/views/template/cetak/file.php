	...
	<div class="row">
		<div class="col-lg-12">
			...
			<h6 align="center">
				...
				<p> sudah menunggak lama <?php print $getInfo['lama_tunggakan']; ?> bulan </p>
				<p> Menunggak dari bulan <?php print $getInfo['awal']; ?> sampai bulan <?php print $getInfo['akhir']; ?> </p>
