...
<head>
    <title>AIR NUSANTARA</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!--===============================================================================================-->
    <link rel="icon" type="image/jpg" href="<?= base_url('assets/'); ?>vendor/login/images/logoair.jpg" />
    <!--===============================================================================================-->
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-pic js-tilt" data-tilt>
                    <img src="<?= base_url('assets/'); ?>vendor/login/images/logo.jpg" style="width: 300px; height: 350px;" alt="IMG">
                </div>
                ...
                <form class="login100-form validate-form" method="post" action="<?= base_url('AuthLogin/register'); ?>">
                    ...
                    <div class="wrap-input100 validate-input">
                        <input class="input100" type="text" id="no_kontrol" name="no_kontrol" placeholder="No Kontrol/ID" value="<?= set_value('username'); ?>">
